...
- (void)viewDidLoad {
    ...
    NSString *strImageUrl = [NSString stringWithFormat:@"https://app.logiqfish.com/uploads/screencap/%@_%@_screencap.png",_deviceListModel.strUserId,_deviceListModel.strDeviceId];
